...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Spinner colorSpin = (Spinner)findViewById(R.id.spinner_color);
        Spinner locationSpin = (Spinner)findViewById(R.id.spinner_location);
        Spinner shapeSpin = (Spinner)findViewById(R.id.spinner_shape);
        Spinner sizeSpin = (Spinner)findViewById(R.id.spinner_size);
        Spinner billSpin = (Spinner)findViewById(R.id.spinner_bill);
        Spinner wingSpin = (Spinner)findViewById(R.id.spinner_wing);
        Spinner tailSpin = (Spinner)findViewById(R.id.spinner_tail);
        Spinner irisSpin = (Spinner)findViewById(R.id.spinner_iris);
